    ...
    <div className="bg-white dark:bg-black">
      ...
      <div className="container mx-auto sm:px-2 md:px-2 mt-10">
        <p className="text-2xl font-mono dark:text-white">
          I'm a Software Developer, Technical Writer, YouTuber, and a passionate
          learner. I am currently writing various Technical Articles at
          GeeksforGeeks. As a CS student, I have been working on various
          projects in the past. The tech stack that I mostly used are React
          Native, AWS, Firebase, Java, SQL, etc. I have contributed to various
          open-source projects and also mentored at Girlscript Summer of Code
          2022, where I have assisted the Project admin and various other
          open-source contributors with their queries.
        </p>
      </div>
      <h2 className="dark:text-white container mx-auto sm:px-2 md:px-2 text-6xl font-bold font-mono mt-10">
        Tech Stack
      </h2>
      <section className="container mx-auto sm:px-2 md:px-2 max-h-max mt-10">
        <div className="flex flex-wrap justify-between">
          <div className="flex flex-col  w-20 text-center">
            ...
            <h4 className="text-1xl font-mono dark:text-white">React</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <path
            ...
            <h4 className="text-1xl font-mono dark:text-white">HTML5</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <path
            ...
            <h4 className="text-1xl font-mono dark:text-white">CSS3</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <path
            ...
            <h4 className="text-1xl font-mono dark:text-white">JavaScript</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
            ...
            <h4 className="text-1xl font-mono dark:text-white">TypeScript</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <path
            ...
            <h4 className="text-1xl font-mono dark:text-white">MySQL</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <path
            ...
            <h4 className="text-1xl font-mono dark:text-white">Firebase</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <path
            ...
            <h4 className="text-1xl font-mono dark:text-white">Tailwind CSS</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <defs>
            ...
            <h4 className="text-1xl font-mono dark:text-white">Bootstrap</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <path
            ...
            <h4 className="text-1xl font-mono dark:text-white">Git</h4>
          </div>
          <div className="flex flex-col w-20 text-center">
            <svg viewBox="0 0 128 128">
              <g fill="#181616">
            ...
            <h4 className="text-1xl font-mono dark:text-white">GitHub</h4>
          </div>
        </div>
      </section>
      <h2 className="dark:text-white container mx-auto sm:px-2 md:px-2 text-6xl font-bold font-mono mt-5">
        Education
      </h2>
      <section className="container mx-auto sm:px-2 md:px-2 mt-10">
          <div className="flex flex-col md:flex-row px-10 justify-between">
            <div className="w-48 h-48 p-4 drop-shadow-md dark:drop-shadow-xl rounded-full bg-bgGray dark:bg-gray-100">
              <img src={msilogo} alt="MSI" />
            </div>
            <div className="w-9/12 sm:w-fit md:w-9/12 text-left drop-shadow-md dark:drop-shadow-xl bg-bgGray dark:bg-gray-200 p-4 rounded-xl">
              <div className="flex flex-row">
                <h2 className="md:text-2xl lg:text-3xl font-mono font-bold">
                  Maharaja Surajmal Institute (GGSIP University)
                </h2>
                <p className="text-sm font-bold absolute right-5 sm:top-9 md:top-5">2019-2022</p>
              </div>
              <h2 className="md:text-2xl lg:text-2xl font-mono ">
                Bachelor of Computer Applications
              </h2>
              <div className="mt-2">
                <ul className="list-none">
                  <li>⚡Scored <span className="font-bold">9.33</span> GPA overall in my degree.</li>
                  <li>
